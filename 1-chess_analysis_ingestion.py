...
"""**CRIAÇÃO DO DATA FRAME COM OS RATINGS POR ATLETAS**"""
...
fidedf.to_csv('fidedfv4.csv')
!cp fidedfv4.csv "drive/My Drive/"

carlsen = fidedf[fidedf['Name']=='carlsen']
carlsen.plot(x='time_playing', y='Rating')
